...
import (
	...
	"github.com/masonhubco/rebar/helpers"
...
func Test_APIRender(t *testing.T) {
	t.Run("Good Widget", func(t *testing.T) {
		...
		helpers.APIRenderList(rr, req, 1, Widgets{FieldOne: "one", FieldTwo: "two"})
...
`, rr.Body.String())
	...
	t.Run("Bad Widget", func(t *testing.T) {
		...
		helpers.APIRenderList(rr, req, 1, Widgets{FieldOne: func() {}})
